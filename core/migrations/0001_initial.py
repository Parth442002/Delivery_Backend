# Generated by Django 3.2.9 on 2021-11-26 19:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('govt_corp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.governmentcorp')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='owner', to=settings.AUTH_USER_MODEL)),
                ('renewable_energy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.renewableenergy')),
            ],
        ),
    ]
